...
public class ConversaoDeValor {
    private static final String API_KEY = "90896efb8d23d3b6cf07d9a8";

    public String converter(String moedaOrigem,
                            String moedaDestino,
                            double valor) {
        ...
        try {
            ...
            MoedaResponse moeda = new Gson().fromJson(json,
                                                      MoedaResponse.class);
            ...
            return String.format("O valor %.2f %s convertido para %s é de $ %.2f",
                                 valor,
                                 moedaOrigem,
                                 moedaDestino,
                                 valorConvertido
            ...
            return "Erro: código de moeda inválido";
        }
    }
}
